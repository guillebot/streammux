...
public class ActivityController {
    ...
    public List<JobEvent> listActivity(
        ...
        @Parameter(description = "Filter by event type (may be repeated to select multiple; results include events matching any listed type)") @RequestParam(name = "eventType", required = false) List<EventType> eventType,
